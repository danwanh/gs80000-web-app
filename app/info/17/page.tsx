...
export default function Info17Page() {
  return (
    <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
      <div className="lg:col-span-3">
        <div>
            <div className="bg-[#0071bc] border-b-4 border-gray-300 p-2 mb-6">
              <h2 className="text-white font-medium text-lg">ハピネスプラザ「練馬春日町]オープンのお知らせ</h2>
            ...
            <Image src="/info_017.png" 
             ...
             <div className="space-y-5">
                ...
                <p>〒179-0074　東京都練馬区春日町6-6-39-103
                <br></br>営業時間　10：00～19：00
                <br></br>休憩時間　13：00～14：00
                <br></br>休日　土・日・祝日</p>

                <a
                    href={"https://maps.app.goo.gl/Vq17yEs8StDFrcqu6"}
