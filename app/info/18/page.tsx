      ...
      <div className="lg:col-span-3">
        <div>
            <div className="bg-[#0071bc] border-b-4 border-gray-300 p-2 mb-6">
              <h2 className="text-white font-medium text-lg">ハピネスプラザ「雪が谷大塚]オープンのお知らせ</h2>
              <div className="text-sm text-gray-700 leading-relaxed space-y-3"></div>
            </div>
            <p className="text-right mb-5">2025/05/26</p>
            
            <Image src="/info_018.png" 
                            alt="会社案内" 
                            width={900}
                            height={256}
             ...
             <div className="space-y-5">
                ...
                <p>〒145-0066　東京都大田区南雪谷4-7-13 ホークパレス南雪谷101
                <br></br>営業時間　9：00～18：00
                <br></br>休憩時間　13：00～14：00
                <br></br>休日　土・日・祝日</p>

                <a
                    href={"https://maps.app.goo.gl/WAEyWYgCZvK6LDob6"}
