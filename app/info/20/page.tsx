...
export default function Info20Page() {
  return (
    <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
      <div className="lg:col-span-3">
        <div>
            ...
            <p className="text-right mb-5">2024/07/15</p>
            <div className="ml-3">
                <p className="mb-10">
                ...
                <p className="mb-10">
                    8月7日(木)正午までのご注文→8月8日(金)発送 <br></br>8月7日(木)正午以降～8月17日までのご注文→8月19日(火)発送
                    12月26日(木)正午以降～1月6日までのご注文→1月8日(火)発送
                </p>

                <p>
                    休業期間中は、お問い合わせメール・お電話には対応できません。 <br></br>
                    メールの受信は行っておりますが、お返事・発送は8月18日以降となります。<br></br>
